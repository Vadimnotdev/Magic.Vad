...
class LogicCommand:
    def __init__(self):
        self.executeSubTick = -1

    def isServerCommand(self) -> bool:
        return False
    ...
    def encode(self, encoder: ChecksumEncoder):
        encoder.writeInt(self.executeSubTick)

    def decode(self, stream: ByteStream):
        self.executeSubTick = stream.readInt()


    def destruct(self):
        self.executeSubTick = -1

    def setExecuteSubTick(self, tick: int):
        self.executeSubTick = tick

    def getExecuteSubTick(self) -> int:
        return self.executeSubTick


class LogicCommandType(Enum):
    JOIN_ALLIANCE = 1
    LEAVE_ALLIANCE = 2
